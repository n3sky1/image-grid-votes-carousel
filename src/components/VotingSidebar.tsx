    ...
    <div className="bg-white/70 border border-blue-100 rounded-lg p-4 mb-2">
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input id="tshirt-asin" type="text" value={asin} readOnly className="bg-gray-100 cursor-not-allowed border-gray-200" />
        </div>
        <div>
          <Label htmlFor="ai-rec-model" className="block mb-1 text-gray-700 font-medium">Generated By:</Label>
          <Input id="ai-rec-model" type="text" value={aiRecommendedModel || ""} readOnly className="bg-gray-100 cursor-not-allowed border-gray-200" />
        </div>
      </div>
    </div>
