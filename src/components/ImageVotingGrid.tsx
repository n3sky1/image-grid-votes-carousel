...
const ImageVotingGrid = ({
  initialImages
}: ImageVotingGridProps) => {
  ...
  return <div className="w-full max-w-6xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div className="flex flex-col">
          ...
          {originalImage ? <div className="flex-1 flex items-center justify-center bg-white rounded-lg p-4 shadow-md">
              <ImageCard image={originalImage} className="max-h-[500px] w-auto" />
            </div> : <div className="flex-1 flex items-center justify-center bg-gray-50 border rounded-lg p-8">
        ...
        <div className="flex flex-col">
          ...
          <div className="flex-1 flex items-start">
            <ImageCarousel images={images} onVote={handleVote} />
          </div>
          ...
          <div className="mt-4 p-4 bg-white rounded-lg shadow-sm">
            <div className="flex flex-col">
              ...
              <div className="w-full bg-gray-200 rounded-full h-2.5">
                ...
                width: `${Object.keys(votedImages).length / (initialImages.length - 1) * 100}%`
              }}></div>
              </div>
